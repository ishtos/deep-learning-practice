...
class UNet:
    def __init__(self, input_size=(256, 256, 1)):
        ...
        conv6_1 = my_Conv2D(filters=512, kernel_size=2)(up6)  # crop by kernel_size
        ...
        conv7_1 = my_Conv2D(filters=256, kernel_size=2)(up7)  # crop by kernel_size
        ...
        conv8_1 = my_Conv2D(filters=128, kernel_size=2)(up8) # crop by kernel_size
        ...
        conv9_1 = my_Conv2D(filters=64, kernel_size=2)(up9) # crop by kernel_size
        ...
        model.compile(loss=self.dice_coef_loss, optimizer=Adam(), metrics=[self.dice_coef])
